...
root <-"http://map.baidu.com/search/%E5%B1%85%E5%A7%94%E4%BC%9A/@12951786.705967559,4850229.302455757,14.83z?querytype=s&c=131&wd=%E5%B1%85%E5%A7%94%E4%BC%9A&da_src=shareurl&on_gel=1&l=14&gr=1&b=(12947522.218633452,4847773.855538119;12956715.555538973,4853097.731304696)&pn=0&device_ratio=2"

construct.poicode.url <- function(page_num="0") {
  root <- "http://api.map.baidu.com/place/v2/search?q=居委会&b=(12947522.218633452,4847773.855538119;12956715.555538973,4853097.731304696)&output=json&ak=C93b5178d7a8ebdb830b9b557abce78b&page_num="
  u <- paste(root,page_num,sep = "")
  return(URLencode(u))
}

res<-getURL( root)
json <- jsonlite::fromJSON(res)
